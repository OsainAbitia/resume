...
\begin{document}
	...
	%----------------------------------------------------------------------------------------
	%	EXPERIENCE - List activities and be quantitative and order technologies for SWE
	%----------------------------------------------------------------------------------------
	...
	\begin{entrylist}
		...
		{Apli Jobs} % Be more explicit on the job description  with specific examples.
		...
		{Apli Jobs} % Mention collaboration with teams, projects like CME, bb8
	...
	%----------------------------------------------------------------------------------------
	%	Education - Move to top alongside the hard skills
	%----------------------------------------------------------------------------------------
